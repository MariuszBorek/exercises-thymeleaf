...
public class FileDownloadController {
    ...
    public FileDownloadController(DatabaseFileService fileStorageService) {
...
//        DatabaseFile databaseFile = fileStorageService.getFile(Integer.parseInt(fileName.trim()));
//
